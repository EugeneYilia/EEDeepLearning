...
/**
 * <h3>EALS: efficient Alternating Least Square for Weighted Regularized Matrix
 * Factorization.</h3>
 * <p>
 ...
 * <li>Fast Matrix Factorization for Online Recommendation With Implicit
 * Feedback, SIGIR 2016</li>
 * </ul>
 *
 * @author Keqiang Wang
 */
public class EALSRecommender extends MatrixFactorizationRecommender {
	...
	public void prepare(Configuration configuration, SampleAccessor marker, InstanceAccessor model, DataSpace space) {
		...
		weights = SparseMatrix.copyOf(trainMatrix, false, (row, column, value, message) -> {
			if (type == 1 || type == 2) {
				return 1F + weightCoefficient * value;
			} else {
				return 1F;
			}
		});
